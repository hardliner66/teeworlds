...
MACRO_CONFIG_INT(SvfCatchMinMap, sv_plus_min_map, 0, 0, 1, CFGFLAG_SERVER, "Min play time is needed, bevor map can be changed")
MACRO_CONFIG_INT(SvfCatchMinMapTime, sv_plus_min_map_time, 15, 0, 1440, CFGFLAG_SERVER, "Minimum time before the map can be changed")
MACRO_CONFIG_INT(SvfCatchMinMapPlayerTime, sv_plus_min_map_player_time, 5, 0, 1440, CFGFLAG_SERVER, "Minimum time a player must be in game before the map can be changed")
MACRO_CONFIG_INT(SvfCatchShowCapturedPlayers, sv_plus_show_captured_players, 1, 0, 1, CFGFLAG_SERVER, "Score shows captured players instead of kills")
#endif
