#ifndef GAME_SERVER_GAMEMODES_ITRAIN_H
#define GAME_SERVER_GAMEMODES_ITRAIN_H
#include "race.h"

class CGameControllerITrain : public CGameControllerRACE
{
...
public:
	CGameControllerITrain(class CGameContext *pGameServer);
